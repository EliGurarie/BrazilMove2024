...
<font color = "darkred"> 
**Presentations:**  Please come prepared with 2-3 slides to introduce yourself, your study system, your ecological questions, and a brief description of your data. 
</font>
...
- [**R** Lab](Day1/02_ProcessingData/Lab1_DataProcessing.html) ([code](Day1/02_ProcessingData/Lab1_DataProcessing.R))
  - data here: [Elk_GPS_data.csv](data/Elk_GPS_data.csv) (right-click to download), also available on Movebank [here](https://www.movebank.org/cms/webapp?gwt_fragment=page=studies,path=study897981076).  With a huge **thank you** to [Dr. Mark Hebblewhite](https://www.umt.edu/ungulate-ecology-lab/) and the enormous amount of work and research that went into the [Ya Ha Tinda long-term monitoring project](https://www.umt.edu/yahatinda/)). 
...
<font color = "darkred"> 
**Exercise:** *Download, process and visualize your movement data.*
</font>
...
<font color = "darkred"> 
**Exercise:** *Generate a summary table - with an emphasis on sampling intervals, total duration, and some step length and turning angle statistics from your data.*
</font>

## 6. Movement Models

See also these [**book chapters**](https://eligurarie.github.io/MovementEcologyBook) on [Discrete](https://eligurarie.github.io/MovementEcologyBook/part4_movement_models/discrete_movement_models.html) and [Continuous](https://eligurarie.github.io/MovementEcologyBook/part4_movement_models/continuous_movement_models.html) movement models. 
...
<center>
![BrazilMove2024 participants - UFMS Campo Grande](images/todos_cropped.jpg)
</center>
